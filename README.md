...
Jupyter+R: [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/w201rdada/exhibits/master?filepath=index.ipynb)

RStudio: [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/w201rdada/exhibits/master?urlpath=rstudio)

RShiny: [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/w201rdada/exhibits/master?urlpath=shiny/sampling-frame/)
...
This repository also contains an example of a [Shiny app](https://github.com/w201rdada/exhibits/tree/master/sampling-frame).
...
**[r-conda](https://github.com/w201rdada/exhibits-conda)** - mybinder.org also
...
- For the RStudio environment, we must add the following at the end of the URL: `?urlpath=rstudio`
  ...
  - Example: http://mybinder.org/v2/gh/w201rdada/exhibits/master?urlpath=rstudio
...
name of the repository, placing instead a hyphen (the reason is that spaces are converted to `%20`).
  ...
  - Example: http://mybinder.org/v2/gh/w201rdada/exhibits/master?urlpath=shiny/sampling-frame/
